--[[
	...
	目录：
		...
		十三、视为技实例分析（卡牌使用）Line549～Line626
		十四、视为技实例分析（卡牌响应）Line628～Line682
		十五、视为技实例分析（锁定视为技）Line684～Line742
		十六、视为技实例分析（技能卡）Line744～Line859
		十七、技能实例综合分析 Line861～Line994
]]--
...
--	接下来的两个参数target和target2，只知道可能提示信息有关，不过一般来说似乎也不怎么常用。
...
--	S：视为卡牌的花色字符串，本例中可以用club:getSuitString()得到，
--	当然也可以直接写sgs.Card_Club，因为这个已经很明确了。
